...
class AdminBasicModel extends Model{
	...
	public function getMenu(){
		...
		// if (cache('bjy_Admin:LeftMenuByGid:'.cookie('admin_group'))) {
		// 	return unserialize(cache('bjy_Admin:LeftMenuByGid:'.cookie('admin_group')));
		// }
		...
		// cache('bjy_Admin:LeftMenuByGid:'.cookie('admin_group'), serialize($menuArr), 3600);
	...
	public function getHeaderList(){
		// if (cache('bjy_Admin:HeaderList')) {
		// 	return cache('bjy_Admin:HeaderList');
		// }
		...
		// cache('bjy_Admin:HeaderList', $queryRes[0]['list']);
