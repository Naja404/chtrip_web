  ...
  <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
	...
	<div id="content">
	  <div id="content-header">
	    <div id="breadcrumb"> <a href="<?php echo U('Index/index');?>" title="<?php echo L('text_goto_home');?>" class="tip-bottom"><i class="icon-home"></i> <?php echo L('text_home');?></a> <a><?php echo L('text_setting');?></a> <a href="<?php echo U('Setting/menuList');?>" class="current"><?php echo L('text_setting_menu');?></a> </div>
	  </div>
	      ...
	      <div class="span12">
	        <div class="widget-box">
	          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
	            <h5><?php echo L('text_setting_menu_list');?></h5>
	            <span class="label label-info">
	            	<a data-toggle="modal" href="#modal-add-menu" id="modal_show"><i class="icon-plus icon-white"></i><?php echo L('btn_add_menu');?></a>
	            </span>
	          </div>
	          <div class="widget-content nopadding">
	            <table class="table table-bordered table-striped">
	              <thead>
	                <tr>
	                  <th><?php echo L('text_menu_module');?></th>
	                  <th><?php echo L('text_menu_title');?></th>
	                  <th><?php echo L('text_menu_url');?></th>
	              ...
	              <tbody>
	                  ...
	                  <td><?php echo ($item["menu_module"]); ?>－<?php echo ($item["menu_title"]); ?></td>
	                  <td><?php echo ($item["title"]); ?> / <?php echo L('text_menu_display_'.$item['is_display']);?></td>
	                  <td><?php echo ($item["name"]); ?></td>
	                  <td id="status_<?php echo ($item["id"]); ?>">
	                  	<input type="button" class="btn btn-danger" name="" value="<?php echo L('btn_suemail_del');?>" onclick="delMenu('<?php echo ($item["id"]); ?>');return false;"/>
	                  	<input type="button" class="btn btn-info" name="" value="<?php echo L('btn_menu_edit');?>" onclick="getMenuDetail('<?php echo ($item["id"]); ?>');return false;"/>
	                  </td>
	...
	<div class="modal-header">
	  ...
	  <h3><?php echo L('text_add_menu');?></h3>
	</div>
	<div class="modal-body">

		<p><?php echo L('text_menu_module_title');?></p>
		<p>
			<input type="text" name="menu_module" value="" placeholder="<?php echo L('text_note_module');?>" />
		</p> 

		<p><?php echo L('text_menu_module');?></p>
		<p>
			<input type="text" name="menu_title" value="" placeholder="<?php echo L('text_note_module_title');?>" />
		</p>

		<p><?php echo L('text_menu_url');?></p>
		<p>
			<input type="text" name="name" value="" placeholder="<?php echo L('text_note_url');?>" />
		</p> 

		<p><?php echo L('text_menu_url_title');?></p>
		<p>
			<input type="text" name="title" value="" placeholder="<?php echo L('text_note_title');?>" />
		</p> 

		<p><?php echo L('text_menu_display');?></p>
		<p>
			<select name="is_display" style="width:100px;">
				<option value="1"><?php echo L('text_menu_display_1');?></option>
				<option value="0"><?php echo L('text_menu_display_0');?></option>
			</select>
		</p> 
	...
	<div class="modal-footer"> 
		<a href="#" class="btn" data-dismiss="modal" id="dismiss_modal"><?php echo L('btn_cancel');?></a> <a href="#" id="add-menu-submit" class="btn btn-primary"><?php echo L('btn_submit');?></a>
	</div>
	</form>
	</div>
...
function getMenuDetail(rid){
	$.ajax({
		type:"POST",
		url:"<?php echo U('Setting/getMenuDetail');?>",
		data:{rid:rid},
...
function subForm(){
	$.ajax({
		type:"POST",
		url:"<?php echo U('Setting/setMenuForm');?>",
...
function delMenu(rid){
	if (confirm("<?php echo L('text_menu_del_confirm');?>")) {
		$.ajax({
			type:"POST",
			url:"<?php echo U('Setting/delMenu');?>",
			data:{rid:rid},
			success:function(data){
				location.reload();
			}	
